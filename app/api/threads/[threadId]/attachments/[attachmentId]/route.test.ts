...
function request() {
  return new Request("http://localhost/api/threads/thread-1/attachments/attachment-1");
}

const context = {
  params: Promise.resolve({ threadId: "thread-1", attachmentId: "attachment-1" }),
};

describe("GET /api/threads/:threadId/attachments/:attachmentId", () => {
  beforeEach(() => {
    vi.clearAllMocks();
