...
const context = {
  params: Promise.resolve({ threadId: "thread-1", artifactId: "artifact-1" }),
};
const request = () => new Request("http://localhost/api/threads/thread-1/artifacts/artifact-1");

describe("GET /api/threads/:threadId/artifacts/:artifactId", () => {
  beforeEach(() => {
    vi.clearAllMocks();
