...
/**
 * POST /api/threads/{threadId}/user-actions/{requestId}/resolve — 员工解析通用 UserAction 请求（§3.18）。
 *
 * 事实源：
...
export async function POST(request: Request, context: RouteContext): Promise<Response> {
  ...
  const userActionRequestId = typeof params.requestId === "string" ? params.requestId : "";
