...
/**
 * GET /admin/api/evaluation-runs/{runId}/cases/{caseId}/results — 列出 Case 下所有 Result（S11-W06）。
 *
 * 行为：
...
export async function GET(request: Request, context: RouteContext): Promise<Response> {
  ...
  const results = await listEvaluationResultsByCase(principal.tenantId, caseId, { limit });
