...
/**
 * GET /admin/api/knowledge-bases/{baseId}/documents/{documentId}/revisions/{revisionId}
...
interface RouteContext {
  params: Promise<{ baseId: string; documentId: string; revisionId: string }>;
}
...
export async function GET(request: Request, context: RouteContext): Promise<Response> {
  ...
  const { baseId, documentId, revisionId } = await context.params;
