...
/**
 * GET / POST /admin/api/knowledge-bases/{baseId}/documents/{documentId}/revisions
...
// ─── GET /admin/api/knowledge-bases/{baseId}/documents/{documentId}/revisions ──
...
export async function GET(request: Request): Promise<Response> {
  ...
  if (!baseId || !documentId) {
    return schemaInvalidTable(requestId, "路径缺少 base_id 或 document_id");
  }
...
// ─── POST /admin/api/knowledge-bases/{baseId}/documents/{documentId}/revisions ──
