...
/**
 * GET / POST /admin/api/knowledge-bases/{baseId}/documents/{documentId}/revisions/{revisionId}/chunks
...
function extractPathIds(url: string): PathIds {
  // 路径形如 .../revisions/{revisionId}/chunks
