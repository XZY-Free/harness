/**
 * GET / POST /admin/api/capability-reviews — CapabilityReview 集合（阶段 6 S06-C05）。
 *
...
// ─── GET /admin/api/capability-reviews ─────────────────
...
// ─── POST /admin/api/capability-reviews ────────────────
