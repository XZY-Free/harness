/**
 * GET / POST /admin/api/capability-reviews/{reviewId} — CapabilityReview 单资源（阶段 6 S06-C05）。
 *
...
// ─── GET /admin/api/capability-reviews/{reviewId} ─────
...
// ─── POST /admin/api/capability-reviews/{reviewId} ────
