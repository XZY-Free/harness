...
/**
 * GET /gateway/memory-candidates/{candidateId} — 查询 Memory Candidate（阶段 7 S07-C03）。
 *
 * 事实源：
...
function extractCandidateId(url: string): string | null {
  // 路径形如 /gateway/memory-candidates/{candidateId}
...
/** GET /gateway/memory-candidates/{candidateId} handler。 */
