...
export const mysqlRouteEligibilityStore: RouteEligibilityStore = {
  upsertProjection: async (input: UpsertProjectionInput) => {
    const values = {
      ...
      agentDescriptorSnapshotId: input.agentDescriptorSnapshotId,
      agentProviderDescriptorDigest: input.agentProviderDescriptorDigest,
      agentInvocationContextContractDigest: input.agentInvocationContextContractDigest,
    ...
    await db
      ...
      .onDuplicateKeyUpdate({
        set: {
          ...
          agentDescriptorSnapshotId: sql`VALUES(agentDescriptorSnapshotId)`,
          agentProviderDescriptorDigest: sql`VALUES(agentProviderDescriptorDigest)`,
          agentInvocationContextContractDigest: sql`VALUES(agentInvocationContextContractDigest)`,
