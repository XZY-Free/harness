...
export const mysqlRouteEligibilityStore: RouteEligibilityStore = {
  upsertProjection: async (input: UpsertProjectionInput) => {
    const values = {
      ...
      agentEndpointRef: input.agentEndpointRef,
      agentIdentityMode: input.agentIdentityMode,
      agentCredentialRefId: input.agentCredentialRefId,
      agentNetworkZone: input.agentNetworkZone,
    ...
    await db
      ...
      .onDuplicateKeyUpdate({
        set: {
          ...
          agentEndpointRef: sql`VALUES(agentEndpointRef)`,
          agentIdentityMode: sql`VALUES(agentIdentityMode)`,
          agentCredentialRefId: sql`VALUES(agentCredentialRefId)`,
          agentNetworkZone: sql`VALUES(agentNetworkZone)`,
