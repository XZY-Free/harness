...
/**
 * V10 Phase 7-5：Web Playwright runner 标识。
...
// V10 Phase 2：QA storageState 派生已移除（原 V9 从 UserBrowserProfile 解密登录态）。
// Web 端 QA 现在以未登录态运行；Phase 7 Desktop QA 隐藏 WebContents 再经 RPC 派生。
