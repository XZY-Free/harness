 ...
 *
 * 变更：执行器从 desktopUnavailable() 占位迁移到真正的 Desktop RPC 调用。
 ...
 * 路由到 Desktop 执行
 *
 * 变更：browserListDownloads 从 desktopUnavailable 迁移到 Desktop RPC，
