...
export const API_ERROR_CODES = {
  ...
  AGENT_CALL_BINDING_INVALID: { http: 409, retryable: false },
  AGENT_CALL_CREDENTIAL_UNAVAILABLE: { http: 503, retryable: false },
  AGENT_CALL_EXECUTOR_UNAVAILABLE: { http: 503, retryable: false },
  AGENT_CALL_FAILED: { http: 503, retryable: false },
  AGENT_CALL_IDEMPOTENCY_CONFLICT: { http: 409, retryable: false },
  AGENT_CALL_TRANSPORT_FAILED: { http: 503, retryable: true },
