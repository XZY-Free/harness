...
/**
 * S1（11-P1-5）：skill 发布校验失败(缺 name/description、非法 YAML、未知 tools 等)。
 *
 ...
 */
/**
 * S1（11-P1-5）：skill 发布校验。检查 SKILL.md 可解析 + name 非空 + description 显式存在 + tools 引用在已知工具集。
...
export async function commitSkillVersion(name: string, message: string): Promise<string> {
  // S1（11-P1-5）：发布前校验工作副本 SKILL.md（即将 commit 的内容）。
