...
/**
 * : 创建基于 Delivery 模型的 Outbox Relay Worker。
 *
 * 与旧 Worker 的区别：
...
export function createOutboxRelayWorker(
 ...
 /** : FOR UPDATE SKIP LOCKED 领取 Delivery 行。 */
 ...
 /** : 续租 — 延长当前 Delivery 的租约（带 lockedBy 条件）。 */
