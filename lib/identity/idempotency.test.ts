...
describe("callerFromPrincipal", () => {
  it("Principal → callerType=user, callerId=userIdentityId", () => {
...
describe("callerFromWorkloadPrincipal", () => {
