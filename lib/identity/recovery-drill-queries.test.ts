/**
 * S12-W08：备份恢复演练集成测试（真实 MySQL 8 Testcontainers）。
 *
 * 覆盖：
...
import {
  ...
  runConsistencyCheck,
} from "@/lib/identity/recovery-consistency-checker";
import {
...
describe("updateRecoveryDrillState", () => {
...
describe("startRecoveryDrill / completeRecoveryDrill / failRecoveryDrill / cancelRecoveryDrill", () => {
