...
function buildRuntimeEndpointResolution(runtimeRevisionId: string): RuntimeEndpointResolution {
  return {
    ...
    gatewayEndpoints: {
      events: "https://platform.internal/gateway/events",
      cancel: "https://platform.internal/gateway/cancel",
      resume: "https://platform.internal/gateway/resume",
      steer: "https://platform.internal/gateway/steer",
      tools: "https://platform.internal/gateway/tools",
      tool_calls: "https://platform.internal/gateway/tool-calls",
      user_action_requests: "https://platform.internal/gateway/user-action-requests",
      capability_actions: "https://platform.internal/gateway/capability-actions",
    },
    governanceConfig: {
