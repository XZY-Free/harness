 ...
 * 轻量 i18n 字典。
 *
 * 12-系统性迁移——DICT 字典覆盖 Studio 各面板 + chat-panel 用户可见文案。
...
/**
 * 子代理 run 状态标签（subagent-panel 共享,收敛局部硬编码字典）。
...
/** plan item 状态标签（thread-plan-panel 共享）。 */
...
/** deployment 状态标签（deployment-panel 共享）。 */
