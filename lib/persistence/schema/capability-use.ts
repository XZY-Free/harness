...
/**
 * 能力类型（与 capability_use.capability_type 对齐）。
 * - skill：Skill 能力资产。
 * - tool：Tool 能力资产。
...
/**
 * 能力使用来源类型（与 capability_use.source_type 对齐）。
 * - default：默认能力。
...
export type NewCapabilityUse = InferInsertModel<typeof capabilityUseTable>;
