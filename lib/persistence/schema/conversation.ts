 ...
 * - assistant_message：Harness 最终回答（冻结架构：顶层 Thread 回答统一由
...
// InvocationCommand 已迁至 lib/persistence/schema/executions.ts（专题02 F12）。
// conversation.ts 只保留会话域产品事实；执行控制命令归 Executions 域唯一 Schema 出口。
