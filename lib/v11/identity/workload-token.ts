/**
 * V11 Workload / Service Identity 模型。
 *
 * 四类 API 受众的身份来源（11-api-and-event-boundaries.md §2.2、§9）：
 ...
 *
 * Token 设计（11-api-and-event-boundaries.md §9.1）：
 ...
 *
 * 事实源：../v11-agentkit-platform/11-api-and-event-boundaries.md §2.2、§9、
 *         ../v11-agentkit-platform/14-production-operations-security-and-retention.md §5。
 */
import { randomUUID } from "node:crypto";
import { V11_STATUS, generateRequestId, v11Error } from "@/lib/http";
...
/** Runtime / Gateway Token 的 claims（11-api-and-event-boundaries.md §9.1）。 */
 ...
 */
export function assertAudienceMatch(claims: WorkloadTokenClaims, expected: V11Audience): void {
 ...
 * Runtime Token 不能用于其他 Invocation 的 API（11-api-and-event-boundaries.md §9.1）。
 */
 ...
 * - agent.revision.create（不是 agent.revision.draft）— 与方案 §8.2 稳定管理动作列表一致。
 */
...
/** V11_STATUS 重新导出，供 route handler 便捷引用。 */
export { V11_STATUS };
