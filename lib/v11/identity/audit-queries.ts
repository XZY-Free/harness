 ...
 *
 * 审计守卫（recordAuditEvent）在 lib/v11/identity/audit.ts，
 * 本模块只提供数据访问，不包含业务判断。
 *
...
import { type AuditActorType, type AuditEvent, auditEvent } from "@/lib/v11/schema/audit";
...
export type { AuditActorType, AuditActionType, AuditEvent } from "@/lib/v11/schema/audit";
