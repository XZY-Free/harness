/**
 * S12-W07：V11 可验证删除集成测试（真实 MySQL 8 Testcontainers）。
 *
 * 覆盖：
...
import { executeDeletionRequest, retryDeletionRequest } from "@/lib/v11/identity/deletion-executor";
...
} from "@/lib/v11/identity/deletion-store-adapter";
import {
  resetDeletionStoreOverrides,
  setDeletionStoreAdaptersOverride,
} from "@/lib/v11/identity/deletion-store-config";
import { createLegalHold } from "@/lib/v11/identity/legal-hold-queries";
...
describe("V11 createDeletionRequest", () => {
...
describe("V11 getDeletionRequestById / getActiveDeletionRequestBySubject", () => {
...
describe("V11 updateDeletionRequestState", () => {
...
describe("V11 setBlockedReasonCodes / parseBlockedReasonCodes", () => {
  it("设置阻塞原因码并解析", async () => {
    const t = await ensureDefaultTenant();
    const req = await createDeletionRequest(buildCreateParams({ tenantId: t.id }));
...
describe("V11 listDeletionRequests", () => {
...
describe("V11 computeRequestSummary / deriveTerminalStateFromSteps", () => {
...
describe("V11 listRunnableSteps / countStepsByStates", () => {
...
describe("V11 executeDeletionRequest", () => {
...
describe("V11 RecordingDeletionStoreAdapter / FailClosedDeletionStoreAdapter", () => {
