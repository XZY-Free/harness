 ...
 * （11-api-and-event-boundaries.md §9.6）。
 *
 * 校验流程：
 * 1. 员工 Session 校验：从 Authorization 解析当前 user_id、tenant_id（由 resolveV11Principal 完成）。
 ...
 *
 * 事实源：../v11-agentkit-platform/11-api-and-event-boundaries.md §9.6、
 *         ../v11-agentkit-platform/10-core-data-model.md §2.1、
