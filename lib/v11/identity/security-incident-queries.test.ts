/**
 * S12-W09：V11 安全事件与隔离止损集成测试（真实 MySQL 8 Testcontainers）。
 *
 * 覆盖：
...
describe("V11 createSecurityIncident", () => {
...
describe("V11 getSecurityIncidentById / getSecurityIncidentByKey", () => {
  it("按 id 查询事故", async () => {
    const t = await ensureDefaultTenant();
    const incident = await createSecurityIncident(buildCreateParams({ tenantId: t.id }));
...
describe("V11 listSecurityIncidents", () => {
...
describe("V11 updateIncidentState", () => {
...
describe("V11 便捷封装（startInvestigation / containIncident / resolveIncident / escalateIncident）", () => {
...
describe("V11 computeContainmentSummary / deriveIncidentContainable", () => {
...
describe("V11 buildIncidentTimeline", () => {
...
describe("V11 getActiveIncidentByTarget", () => {
