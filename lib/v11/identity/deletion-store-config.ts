import type { DeletionStoreAdapter } from "@/lib/v11/identity/deletion-store-adapter";
import { FailClosedDeletionStoreAdapter } from "@/lib/v11/identity/deletion-store-adapter";
/**
 * V11 跨存储删除 Adapter 的运行时配置入口（S12-W07）。
 *
