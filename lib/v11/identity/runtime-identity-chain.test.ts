...
} from "@/lib/v11/identity/runtime-identity-chain";
import { DEFAULT_TENANT_ID } from "@/lib/v11/identity/tenant-queries";
/**
 * S12-W05：V11 Cloud/Remote Runtime 身份链验证单元测试。
 *
 * 覆盖：
...
describe("V11 assertRuntimeLeaseActive", () => {
...
describe("V11 assertRuntimeLeaseBoundToInvocation", () => {
  it("匹配 → 通过", () => {
...
describe("V11 assertRuntimeLeaseBoundToTenant", () => {
  it("匹配 → 通过", () => {
...
describe("V11 assertRuntimeLeaseBoundToRuntimeRevision", () => {
  it("匹配 → 通过", () => {
...
describe("V11 verifyRuntimeIdentityChain", () => {
  it("完整匹配 → 通过", () => {
...
describe("V11 requiresIdentityChainVerification", () => {
