 ...
 *
 * 事实源：
 * - ../v11-agentkit-platform/10-core-data-model.md §6.10 行 504（InvocationCommand 表）、§5.4（ThreadItem 表）
 ...
 * - user_guidance Item 初始 item_state=pending，pending 状态不进入模型上下文（§3.7 行 362）。
