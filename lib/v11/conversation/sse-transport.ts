 ...
 *
 * 事实源：
 * - ../v11-agentkit-platform/11-api-and-event-boundaries.md §3.6（订阅 Event：SSE id = 十进制 event_sequence）
 * - ../v11-agentkit-platform/14-production-operations-security-and-retention.md §2.2（SSE 背压与 cursor_expired）
 *
 * 职责：
 ...
 */
import type { StreamType } from "@/lib/v11/schema/projection";
