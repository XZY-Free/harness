import type { V11ClientEnvironmentAvailability } from "@/lib/v11/client/types";
import {
...
import { DEVICE_HEARTBEAT_TIMEOUT_MS, isDeviceHeartbeatStale } from "./environment-takeover-queries";
...
export interface EnvironmentStatusAggregate {
  readonly environmentDefinition: V11EnvironmentDefinition | null;
...
export function deriveAvailability(params: {
  ...
  readonly activeLease: V11EnvironmentLease | null;
  readonly deviceOnline: boolean | null;
}): V11ClientEnvironmentAvailability {
...
export async function getEnvironmentStatus(
  ...
  let activeLease: V11EnvironmentLease | null = null;
