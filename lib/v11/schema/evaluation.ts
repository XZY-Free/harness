/**
 * V11 Evaluation schema：EvaluationRun / EvaluationCase / EvaluationResult（S11-W06）。
 *
 * 事实源：
...
export const v11EvaluationRun = mysqlTable(
  "v11_evaluation_run",
  {
    ...
    jobId: varchar("job_id", { length: 36 }).references(() => v11Job.id),
...
export type V11EvaluationRun = typeof v11EvaluationRun.$inferSelect;
export type V11EvaluationRunInsert = typeof v11EvaluationRun.$inferInsert;

// ─── V11EvaluationCase ────────────────────────────────────

export const v11EvaluationCase = mysqlTable(
  "v11_evaluation_case",
  {
    id: varchar("id", { length: 36 }).primaryKey(),
    tenantId: varchar("tenant_id", { length: 36 })
    ...
    runId: varchar("run_id", { length: 36 })
      .notNull()
      .references(() => v11EvaluationRun.id),
...
export type V11EvaluationCase = typeof v11EvaluationCase.$inferSelect;
export type V11EvaluationCaseInsert = typeof v11EvaluationCase.$inferInsert;

// ─── V11EvaluationResult ──────────────────────────────────

export const v11EvaluationResult = mysqlTable(
  "v11_evaluation_result",
  {
    id: varchar("id", { length: 36 }).primaryKey(),
    tenantId: varchar("tenant_id", { length: 36 })
      .notNull()
    ...
    caseId: varchar("case_id", { length: 36 }).references(() => v11EvaluationCase.id),
...
export type V11EvaluationResult = typeof v11EvaluationResult.$inferSelect;
export type V11EvaluationResultInsert = typeof v11EvaluationResult.$inferInsert;
