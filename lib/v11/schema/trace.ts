/**
 * V11 Observability schema：Trace / Span / Observation（S11-W05）。
 *
 * 事实源：
 ...
 * - V11Observation.containsSecret 强制为 false：写入前由 content-policy 脱敏，永不存储原始 secret。
...
export const v11Trace = mysqlTable(
  "v11_trace",
  {
...
export type V11Trace = typeof v11Trace.$inferSelect;
export type V11TraceInsert = typeof v11Trace.$inferInsert;
...
export const v11Span = mysqlTable(
  "v11_span",
  {
    id: varchar("id", { length: 36 }).primaryKey(),
    tenantId: varchar("tenant_id", { length: 36 })
...
export type V11Span = typeof v11Span.$inferSelect;
export type V11SpanInsert = typeof v11Span.$inferInsert;
...
export const v11Observation = mysqlTable(
  "v11_observation",
  {
    id: varchar("id", { length: 36 }).primaryKey(),
    tenantId: varchar("tenant_id", { length: 36 })
...
export type V11Observation = typeof v11Observation.$inferSelect;
export type V11ObservationInsert = typeof v11Observation.$inferInsert;
