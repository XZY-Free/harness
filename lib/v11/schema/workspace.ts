/**
 * V11 Workspace schema：workspace / workspace_binding /
...
export const workspace = mysqlTable(
  ...
  (t) => ({
    // 租户内 workspaceKey 唯一。
    tenantKeyUq: uniqueIndex("V11Workspace_tenant_key_uq").on(t.tenantId, t.workspaceKey),
    tenantOwnerIdx: index("V11Workspace_tenant_owner_idx").on(t.tenantId, t.ownerUserId),
    tenantLifecycleIdx: index("V11Workspace_tenant_lifecycle_idx").on(t.tenantId, t.lifecycleState),
  }),
);
...
export const workspaceBinding = mysqlTable(
  ...
  (t) => ({
    tenantWorkspaceIdx: index("V11WorkspaceBinding_tenant_workspace_idx").on(
      t.tenantId,
      t.workspaceId,
    ),
    tenantDeviceIdx: index("V11WorkspaceBinding_tenant_device_idx").on(t.tenantId, t.deviceId),
    tenantStateIdx: index("V11WorkspaceBinding_tenant_state_idx").on(t.tenantId, t.bindingState),
  }),
);
...
export const workspaceAttachment = mysqlTable(
  ...
  (t) => ({
    tenantThreadIdx: index("V11WorkspaceAttachment_tenant_thread_idx").on(t.tenantId, t.threadId),
    tenantBindingIdx: index("V11WorkspaceAttachment_tenant_binding_idx").on(
      t.tenantId,
      t.workspaceBindingId,
    ),
    tenantStateIdx: index("V11WorkspaceAttachment_tenant_state_idx").on(
      t.tenantId,
      t.attachmentState,
    ),
  }),
...
export const workspaceAttachmentUse = mysqlTable(
  ...
  (t) => ({
    ...
    turnAttachmentUq: uniqueIndex("V11WorkspaceAttachmentUse_turn_attachment_uq").on(
      t.turnId,
      t.workspaceAttachmentId,
    ),
    tenantTurnIdx: index("V11WorkspaceAttachmentUse_tenant_turn_idx").on(t.tenantId, t.turnId),
    tenantAttachmentIdx: index("V11WorkspaceAttachmentUse_tenant_attachment_idx").on(
      t.tenantId,
      t.workspaceAttachmentId,
    ),
  }),
...
export type V11Workspace = InferSelectModel<typeof workspace>;
export type V11WorkspaceInsert = InferInsertModel<typeof workspace>;

export type V11WorkspaceBinding = InferSelectModel<typeof workspaceBinding>;
export type V11WorkspaceBindingInsert = InferInsertModel<typeof workspaceBinding>;

export type V11WorkspaceAttachment = InferSelectModel<typeof workspaceAttachment>;
export type V11WorkspaceAttachmentInsert = InferInsertModel<typeof workspaceAttachment>;

export type V11WorkspaceAttachmentUse = InferSelectModel<typeof workspaceAttachmentUse>;
export type V11WorkspaceAttachmentUseInsert = InferInsertModel<typeof workspaceAttachmentUse>;
