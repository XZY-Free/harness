/**
 * V11 Knowledge schema：knowledge_base / knowledge_document /
...
export const knowledgeBase = mysqlTable(
  ...
  (t) => ({
    ...
    tenantKeyUq: uniqueIndex("V11KnowledgeBase_tenant_key_uq").on(t.tenantId, t.knowledgeKey),
    tenantLifecycleIdx: index("V11KnowledgeBase_tenant_lifecycle_idx").on(
      t.tenantId,
      t.lifecycleState,
    ),
    tenantOwnerIdx: index("V11KnowledgeBase_tenant_owner_idx").on(t.tenantId, t.ownerUserId),
  }),
);
...
export const knowledgeDocument = mysqlTable(
  ...
  (t) => ({
    ...
    baseKeyUq: uniqueIndex("V11KnowledgeDocument_base_key_uq").on(t.knowledgeBaseId, t.documentKey),
    tenantBaseIdx: index("V11KnowledgeDocument_tenant_base_idx").on(t.tenantId, t.knowledgeBaseId),
    tenantLifecycleIdx: index("V11KnowledgeDocument_tenant_lifecycle_idx").on(
      t.tenantId,
      t.lifecycleState,
    ),
  }),
...
export const knowledgeDocumentRevision = mysqlTable(
  ...
  (t) => ({
    // 同一文档内 revisionNo 唯一。
    documentRevisionUq: uniqueIndex("V11KnowledgeDocumentRevision_doc_rev_uq").on(
      t.documentId,
      t.revisionNo,
    ),
    tenantDocumentIdx: index("V11KnowledgeDocumentRevision_tenant_doc_idx").on(
      t.tenantId,
      t.documentId,
    ),
    tenantStateIdx: index("V11KnowledgeDocumentRevision_tenant_state_idx").on(
      t.tenantId,
      t.revisionState,
    ),
  }),
...
export const knowledgeChunk = mysqlTable(
  ...
  (t) => ({
    // 同一修订内 chunkNo 唯一。
    revisionChunkUq: uniqueIndex("V11KnowledgeChunk_revision_chunk_uq").on(
      t.documentRevisionId,
      t.chunkNo,
    ),
    tenantRevisionIdx: index("V11KnowledgeChunk_tenant_revision_idx").on(
      t.tenantId,
      t.documentRevisionId,
    ),
  }),
...
export const knowledgeIndex = mysqlTable(
  ...
  (t) => ({
    ...
    chunkProviderUq: uniqueIndex("V11KnowledgeIndex_chunk_provider_uq").on(
      t.chunkId,
      t.indexProvider,
    ),
    tenantProviderIdx: index("V11KnowledgeIndex_tenant_provider_idx").on(
      t.tenantId,
      t.indexProvider,
    ),
  }),
...
export type V11KnowledgeBase = InferSelectModel<typeof knowledgeBase>;
export type V11KnowledgeBaseInsert = InferInsertModel<typeof knowledgeBase>;

export type V11KnowledgeDocument = InferSelectModel<typeof knowledgeDocument>;
export type V11KnowledgeDocumentInsert = InferInsertModel<typeof knowledgeDocument>;

export type V11KnowledgeDocumentRevision = InferSelectModel<typeof knowledgeDocumentRevision>;
export type V11KnowledgeDocumentRevisionInsert = InferInsertModel<typeof knowledgeDocumentRevision>;

export type V11KnowledgeChunk = InferSelectModel<typeof knowledgeChunk>;
export type V11KnowledgeChunkInsert = InferInsertModel<typeof knowledgeChunk>;

export type V11KnowledgeIndex = InferSelectModel<typeof knowledgeIndex>;
export type V11KnowledgeIndexInsert = InferInsertModel<typeof knowledgeIndex>;
