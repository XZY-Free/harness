...
import {
  ...
  isForbiddenField,
  redactContent,
} from "@/lib/v11/observability/content-policy";
import { redactKnownPlaintext, redactStringSecrets } from "@/lib/v11/security/secret-scanner";
...
/** 兼容 content-policy.ts 的 redactContent，作为向后兼容入口。 */
