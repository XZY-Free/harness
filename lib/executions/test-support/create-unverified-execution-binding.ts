...
export const TEST_EXECUTION_BINDING_EVIDENCE: ExecutionBindingControlPlaneEvidence = {
  ...
  agentArtifactId: "test-agent-artifact",
  ...
  agentDescriptorSnapshotId: "test-agent-descriptor-snapshot",
...
export async function createExecutionBinding(
  ...
  await db.insert(executionBindingTable).values({
    ...
    agentArtifactId: params.controlPlaneEvidence.agentArtifactId,
    ...
    agentDescriptorSnapshotId: params.controlPlaneEvidence.agentDescriptorSnapshotId,
    agentProviderDescriptorDigest: params.controlPlaneEvidence.agentProviderDescriptorDigest,
    agentInvocationContextContractDigest:
      params.controlPlaneEvidence.agentInvocationContextContractDigest,
